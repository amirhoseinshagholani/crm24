...
const Login = () => {
    ...
    const getToken = async () => {
        await fetch('https://neka.crm24.io/webservice.php?operation=getchallenge&username=birashk@outlook.com')
            .then(response => response.json())
            .then(data => {
                const str = data.result.token + "SilbiFn0g0jZs5Ln";
                const key = md5(str);
                setAccessKey(key);
            });
    }
    ...
    const getSessionName = async () => {
        await fetch('https://neka.crm24.io/webservice.php',{
            method:'POST',
            headers: {
